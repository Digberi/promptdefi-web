...
export const repayToAaveV3 = async (tokenAddress: string, atomicAmount: BigNumberish, receiver: string) => {
  const operations = [];
  ...
  const repayData = aaveV3PoolInterface.encodeFunctionData('repay', [
    tokenAddress,
    atomicAmount,
    INTEREST_RATE_MODE,
    receiver
