export const templates = [
  ...
  'Swap 100 USDT to ETH and create portfolio with 0.1 WETH and trigger stop loss on -5% and take profit on 10%.',
  ...
  'Swap 100 USDT to Link. Create portfolio with 0.01 WBTC and trigger stop loss on -5% and take profit on +10%.',
